  ...
  : describe("Dynamic SVG NFT Unit Test", () => {
      ...
      describe("constructor", () => {
        it("initializes the counter correctly", async () => {
          const initialCount = await dynamicSvgNft.getTokenCounter();
      ...
      describe("mintNft", () => {
        ...
        it("shifts the token uri to lower when the price doesn't surpass the highvalue", async function () {
          const highValue = ethers.utils.parseEther("100000000000000"); // $100,000,000 dollar per ether. Maybe in the distant future this test will fail...
